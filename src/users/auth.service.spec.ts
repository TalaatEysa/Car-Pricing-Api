...
describe('AuthService', () => {
    ...
    it('throws if an invalid password is provided', async () => {
        await service.signup('talaat@test.com', 'testpassword');
        await expect(
            service.signin('talaat@test.com', 'wrongpassword')
        ).rejects.toThrow(BadRequestException);
    });

    it('returns a user if correct password is provided', async () => {
        await service.signup('talaat@test.com', 'testpassword');
        const user = await service.signin('talaat@test.com', 'testpassword');
